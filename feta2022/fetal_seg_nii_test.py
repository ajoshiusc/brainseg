...
if __name__ == "__main__":
    ...
    outputDir = '/home/ajoshi/projects/disc_mri/clinical_svr_study/SVR_3D_NIFTI_aligned'

    T2wImagePath = '/home/ajoshi/projects/disc_mri/clinical_svr_study/SVR_3D_NIFTI_aligned/SVR010_SVR_aligned.nii.gz' #glob.glob(os.path.join(input_img_dir, 'anat', '*_T2w.nii.gz'))[0]
    ...
    output_file = os.path.join(outputDir, sub + '.label.nii.gz') #'/deneb_disk/feta_2022/test/sub-026/anat/sub-026_rec-mial_T2w66.label.nii.gz'
